(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('react'), require('react-hot-toast'), require('prop-types'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/toConsumableArray'), require('dompurify'), require('react-bootstrap'), require('sweetalert'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/regenerator'), require('axios'), require('react-select'), require('@babel/runtime/helpers/typeof'), require('@tinymce/tinymce-react'), require('react-loader-spinner'), require('bootstrap/dist/css/bootstrap.min.css')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/inherits', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', 'react', 'react-hot-toast', 'prop-types', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/toConsumableArray', 'dompurify', 'react-bootstrap', 'sweetalert', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/regenerator', 'axios', 'react-select', '@babel/runtime/helpers/typeof', '@tinymce/tinymce-react', 'react-loader-spinner', 'bootstrap/dist/css/bootstrap.min.css'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["@opidor/dynamic-form"] = factory(global._classCallCheck, global._createClass, global._inherits, global._possibleConstructorReturn, global._getPrototypeOf, global.React, global.toast, global.PropTypes, global._slicedToArray, global._defineProperty, global._toConsumableArray, global.DOMPurify, global.reactBootstrap, global.swal, global._asyncToGenerator, global._regeneratorRuntime, global.axios, global.Select, global._typeof, global.tinymceReact, global.reactLoaderSpinner));
})(this, (function (_classCallCheck, _createClass, _inherits, _possibleConstructorReturn, _getPrototypeOf, React, toast, PropTypes, _slicedToArray, _defineProperty, _toConsumableArray, DOMPurify, reactBootstrap, swal, _asyncToGenerator, _regeneratorRuntime, axios, Select, _typeof, tinymceReact, reactLoaderSpinner) { 'use strict';
